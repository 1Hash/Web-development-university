...
<html lang="pt-br">
  <head>
    ...
    <title>Alterar Senha - ELentes</title>
        ...
        $("#alterarSenha").validate({
            rules: {
                ...
                novaSenhaInput: {
                    required: true,
                    minlength: 8,
                    notEqual: "#antigaSenhaInput"
                },                
                confirmarSenhaInput: {
                    required: true,
                    equalTo: "#novaSenhaInput"
                }
            },
            messages: {
                antigaSenhaInput: {
    ...
    $(function ($) {
        ...
        $('#alterarSenha').on('submit', function () {

            if(!$("#alterarSenha").valid()) {
                return false;
            }
            else {
      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3 m-b-3">
          ...
          <ul class="nav nav-pills nav-stacked">
            <li role="presentation"><a href="perfil-usuario.php">Perfil</a></li>
            <li role="presentation"><a href="historico-compras.php">Histórico de Compras</a></li>
            <li role="presentation" class="active"><a href="alterar-senha-usuario.php">Alterar Senha</a></li>
          </ul>
        </div>
        <!-- End Account Sidebar -->
        ...
        <div class="col-sm-8 col-md-9">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div id="mensagem"></div>
              <form id="alterarSenha" method="POST" action="./controls/controlUsuario.php">
                <div class="form-group">
                  <label for="antigaSenhaInput">Senha Atual</label>
                  <input type="password" class="form-control" id="antigaSenhaInput" name="antigaSenhaInput" placeholder="Senha Atual">
                </div>
                <div class="form-group">
                  <label for="novaSenhaInput">Nova Senha</label>
                  <input type="password" class="form-control" id="novaSenhaInput" name="novaSenhaInput" placeholder="Nova Senha">
                </div>
                <div class="form-group">
                  <label for="confirmarSenhaInput">Confirme sua Nova Senha</label>
                  <input type="password" class="form-control" id="confirmarSenhaInput" name="confirmarSenhaInput" placeholder="Confirme sua Nova Senha">
                </div>
                <button type="submit" id="salvar" class="btn btn-theme btnAlterarSenha"><i class="fa fa-check"></i> Salvar</button>
              </form>
            </div>
          </div>
        </div>
