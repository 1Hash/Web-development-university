...
$noticia = new Noticia(null, null, null);
...
<html lang="pt-br">
  <head>
    ...
    <title>Detalhes Notícia - ELentes</title>
  ...
  <body class="fade-down">
    ...
    <?php
        ...
        foreach ($noticia->getNoticia($id) as $var) {        
    ?>
    ...
    <div class="breadcrumb-container">
      <div class="container">
        <ol class="breadcrumb">
          <li><a href="index">Home</a></li>
          <li><a href="noticias">Notícias</a></li>
          <li class="active"><?php echo $var['titulo']; ?></li>
        </ol>
      </div>
    </div>
    <!-- End Breadcrumbs -->
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <div class="col-sm-12 blog-detail-content">
          <div class="title"><span><?php echo $var['titulo']; ?></span></div>
          <small>
            <span><i class="fa fa-clock-o"></i> <?php echo date("d/m/Y", strtotime($var['data'])); ?></span>
            <span><i class="fa fa-user"></i> Admin</span>
          </small>
          <!--<img src="images/demo/blog-detail.jpg" alt="Blog Detail" class="img-thumbnail">-->
          <img src="./controls/controlUsuario.php?getImagemN=<?php echo $var['idNoticias']; ?>" alt="" class="img-thumbnail">
          <!--<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat...</p>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>-->
          <p><?php echo nl2br($var['descricao']); ?></p>
        </div>
        <!-- End Content -->
        <?php } ?>  
      </div>
