...
<html lang="pt-br">
  <head>
    ...
    <title>Detalhes Dicas - ELentes</title>
  ...
  <body class="fade-down">
    ...
    <?php
        ...
        foreach ($dica->getDicas($id) as $var) {        
    ?>
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <div class="col-sm-12 blog-detail-content">
          ...
          <img src="./controls/controlUsuario.php?getImagemD=<?php echo $var['idDicas']; ?>" alt="" class="img-thumbnail">
