...
<html lang="en">
  <head>
    ...
    <title>Publicar Notícia - ELentes</title>
    <!-- Bootstrap -->
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <div class="col-sm-12 m-b-3">
          ...
          <div class="title"><span>Publicar Notícia</span></div>
          <div class="row">
            <form id="formulario" method="POST" action="./controls/controlNoticia.php">
              <div class="form-group col-sm-6">
                <label for="tituloNoticiaInput">Título</label>
                <input type="text" class="form-control" id="tituloNoticiaInput" name="tituloNoticiaInput" required="required" placeholder="Título">
              </div>
              <div class="form-group col-sm-12">
                <label for="descricaoNoticiaInput">Descrição</label>
                <textarea style="resize: none" class="form-control" rows="5" id="descricaoNoticiaInput" name="descricaoNoticiaInput" required="required"></textarea>
              </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-xs-12">
                <button id="salvar" type="submit" class="btn btn-theme"><i class="fa fa-long-arrow-right"></i> Publicar Notícia</button>
              </div>
            </form>       
          </div>
        </div>
