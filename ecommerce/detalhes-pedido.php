...
<html lang="pt-br">
  <head>
    ...
    <title>Detalhes do Pedido - ELentes</title>
    ...
    <script>
        ...
        $(function ($) {
            ...
            $('.detalhesProdutoTd').click(function () {
                
                $('#idProd').html(idProduto);
                $('#nomeProd').html(nome);
                $('#esfericoProd').html(grauEsferico);
                
                if (grauCilindro !== "NaN") {
                    $('#cilindroProd').html(grauCilindro);
                }
                else {
                    $('#cilindroProd').html('-');
                }
                ...
                $('#curvaBaseProd').html(curvaBase);
                $('#diametroProd').html(diametro);
                
                if (adicao !== "NaN") {
                    $('#adicaoProd').html(adicao);
                }
                else {
                    $('#adicaoProd').html('-');
                }
                ...
                if (olho !== "") {
                    ...
                    if(olho === 1) {
                        $('#olhoProd').html("Dominante");
                    }
                    else if(olho === 0) {
                        $('#olhoProd').html("Não dominante");
                    }
                }
                else {
                    $('#olhoProd').html('-');
                ...
                //$('#tabelaDetalhesProduto').load('./controls/controlProduto.php?modalDetalhesProduto='+idProduto+' #tabelaDetalhesProduto');
            });
        });
  ...
  <body class="fade-down">
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <!-- My Profile Content -->
        <div class="col-md-12">
            <div class="title m-b-2"><span>Detalhes do Pedido - <b><?php echo $id; ?></b></span></div>
          <div class="row">
            <!--<div class="col-xs-12">-->
              <div class="col-md-12 table-responsive table-scroll-pedido">
                <table class="table table-bordered table-hover table-striped hd-center alinharv">
                    <thead>
                      <tr>
                          <th>Produto</th><th>Quantidade</th><th>Preço</th><th>Detalhes</th><th>Registrar Opinião</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        foreach ($produto->getProdutoHistorico($id) as $var) {

                        ?>
                        
                            <tr>
                                <td><?php echo $var['nome']; ?></td>
                                <td><?php echo $var['quantidadeD'] + $var['quantidadeE']; ?></td>
                                <td>R$ <?php echo $var['valorUnit'];?></td>
                                <td class="detalhesProdutoTd col-sm-1"><button type="button" onclick="idProduto=<?php echo $var['idProduto'] ?>;
                                                                                                      nome='<?php echo $var['nome'] ?>';
                                                                                                      grauEsferico=parseFloat(<?php echo $var['esfericoD'] ?>).toFixed(2); 
                                                                                                      grauCilindro=parseFloat(<?php echo $var['cilindroD'] ?>).toFixed(2); 
                                                                                                      eixo=parseFloat(<?php echo $var['eixoD'] ?>).toFixed(2); 
                                                                                                      adicao=parseFloat(<?php echo $var['adicaoD'] ?>).toFixed(2); 
                                                                                                      curvaBase=parseFloat(<?php echo $var['curvaBaseD'] ?>).toFixed(2); 
                                                                                                      diametro=parseFloat(<?php echo $var['diametroD'] ?>).toFixed(2); 
                                                                                                      cor='<?php echo $var['corD'] ?>'; 
                                                                                                      olho='<?php echo $var['olhoDominante'] ?>'; 
                                                                                                      " data-toggle="modal" data-target="#detalhesProduto" class="btn btn-default btn-sm">Detalhes do Produto <i class="fa fa-list-ul"></i></button></td>
                                
                                <td class="registrarOpiniao col-sm-1">
                                    <form method="POST" action="registrar-opiniao.php">
                                        <input type="text" class="hidden" name="idProduto" value="<?php echo $var['idProduto']; ?>" />
                                        <button type="submit" class="btn btn-theme btn-sm">Registrar Opinião  <i class="fa fa-star"></i></button>
                                    </form>
                                </td>
                            </tr>
    ...
    <div class="modal fade" id="detalhesProduto" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Detalhes do Produto - <b id="idProd"></b></h4>
          </div>
          <div class="tabelaDetalhesProduto modal-body">
              <table class="table table-compare table-bordered">
                  <tbody>
                        <tr>
                            <td>
                                <b>Nome</b>
                        ...
                        <tr>
                            ...
                            <td id="esfericoProd"></td>
                        </tr>
                        <tr>
                            <td>
                                <b>Grau Cilindro</b>
                            </td>
                            <td id="cilindroProd"></td>
                        </tr>
                        <tr>
                            <td>
                                <b>Eixo</b>
                        ...
                        <tr>
                            ...
                            <td id="curvaBaseProd"></td>
                        </tr>
                        <tr>
                            <td>
                                <b>Diâmetro</b>
                            </td>
                            <td id="diametroProd"></td>
                        </tr>
                        <tr>
                            <td>
                                <b>Adição</b>
