...
<html lang="en">
  <head>
    ...
    <title>Relatório Compras - ELentes</title>
    <!-- Bootstrap -->
    ...
    $(document).ready(function(){
        ...
        $('#pesquisarCompras').click(function () {
            
            data1 = $('#data1Compras').val();
            data2 = $('#data2Compras').val();

            $('#tabelaCompras').load('./controls/controlProduto.php?data1Compras='+data1+'&data2Compras='+data2+' #tabelaCompras');
        });
    });
  ...
  <body class="fade-down">
    ...
    <div class="breadcrumb-container">
      <div class="container">
        <ol class="breadcrumb">
          <li><a href="index-admin">Home</a></li>
          <li class="active">Relatório Compras</li>
        </ol>
      </div>
    </div>
    <!-- End Breadcrumbs -->
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <div class="col-sm-12 m-b-3">
          <div class="title"><span>Relatório Compras</span></div>
          <div class="row">
            <form method="POST" action="./controls/controlProduto.php" target="_blank">
              <div class="form-group col-sm-6">
                <label for="data1Compras">Data Início</label>
                <input type="date" name="data1Compras" id="data1Compras" required="required" class="form-control">
              </div>
              <div class="form-group col-sm-6">
                <label for="data2Compras">Data Fim</label>
                <input type="date" name="data2Compras" id="data2Compras" required="required" class="form-control">
              </div>
              ...
              <div class="col-xs-6">
                <button type="button" name="pesquisarCompras" id="pesquisarCompras" class="btn btn-theme"><i class="fa fa-long-arrow-right"></i> Pesquisar</button>
              </div>
              <div class="col-xs-6 text-right">
                <button type="submit" name="relatorioCompras" class="btn btn-theme"><i class="fa fa-long-arrow-right"></i> Emitir Relatório</button>
              </div>
            </form>
          </div>
        </div>
