    ...
    <script>
        $(document).ready(function(){
            $('#produtoInputEstoque').change(function(){
                    ...
                    $("#parametrosEstoque").addClass("hidden");
                    $('#parametrosEstoque2').load('./controls/controlEstoque.php?carregarParametros='+idProduto+' #parametrosEstoque2');
        ...
        $(function ($) {
            ...
            $('#formulario').on('submit', function () {
                        ...
                        var formulario = $(this);
                        var botao = $('#btnCadastrarEstoque');
                        var textoBotao = $('#btnCadastrarEstoque').text();
    ...
    <div class="breadcrumb-container">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">Adicionar ao Estoque</li>
        </ol>
      </div>
    </div>
    <!-- End Breadcrumbs -->
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <div class="col-sm-12 m-b-3">
          ...
          <div class="title"><span>Adicionar ao Estoque</span></div>
          <div class="row">
            <form id="formulario" method="POST" action="./controls/controlEstoque.php">
              <div class="form-group col-sm-6">
                <label for="produtoInputEstoque">Produto</label>
                <select class="form-control selectpicker" id="produtoInputEstoque" name="produtoInputEstoque">
              ...
              <div id="parametrosEstoque2"></div>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" class="form-control" id="inputQuantidadeEstoque" name="inputQuantidadeEstoque" placeholder="Quantidade">
                </div>
              
              <hr style="width: 97.5%;" />

              <div class="col-xs-12">
                <button type="submit" id="btnCadastrarEstoque" class="btn btn-theme"><i class="fa fa-long-arrow-right"></i> &MediumSpace; Adicionar ao Estoque</button>
              </div>
            </form>
          </div>
        </div>
