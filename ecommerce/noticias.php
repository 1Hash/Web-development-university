  ...
  <body class="fade-down">
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <!-- Content -->
        <div class="col-sm-12">
          <div class="title m-b-2"><span>Notícias</span></div>
          ...
          <?php
            ...
            $sqlProdutos = "SELECT * FROM noticias LIMIT $numeroSelecao,$totalProdutosPorPagina";
              ...
              ?>
                ...
                <div class="col-md-6">
                  <div class="thumbnail blog-list">
                    <a href="<?php echo "$urlSite/noticia-detalhe/$url"; ?>">
                        <img src="./controls/controlUsuario.php?getImagemN=<?php echo $var['idNoticias']; ?>" alt="">                      
                    </a>
                    <div class="caption">
                      ...
                      <div class="text-right"><a href="<?php echo "$urlSite/noticia-detalhe/$url"; ?>" class="btn btn-theme btn-sm"><i class="fa fa-long-arrow-right"></i> Saiba Mais</a></div>
                    </div>
                  </div>
                </div>
...
function paginacao($totalProdutos, $totalProdutosPorPagina, $offset) {
    ...
    if ($paginaAtual == 1) {
        ...
        $p = $paginaAtual - 1;
        $paginas .= "<li><a href='$urlSite/noticia/1'><span>&laquo;</span></a></li>";
        $paginas .= "<li><a href='$urlSite/noticia/$p'><span>&lsaquo;</span></a></li>";
    }
    ...
    for ($i = $var; $i < ($paginaAtual - 1) + $offset; $i++ ) {
      ...
      if ($i <= $numeroPaginas && $i >= 1) {
            ...
            if ($i == $var2) {
                $paginas .= " <li class='active'><a href='$urlSite/noticia/$página'>$página</a></li> ";
            }
            else {
                $paginas .= " <li><a href='$urlSite/noticia/$página'>$página</a></li> ";
            }
        }
    }
    ...
    if ($paginaAtual == $numeroPaginas) {
        ...
        $p2 = $paginaAtual + 1;
        $paginas .= "<li><a href='$urlSite/noticia/$p2'><span>&rsaquo;</span></a></li>";
        $paginas .= "<li><a href='$urlSite/noticia/$numeroPaginas'><span>&raquo;</span></a></li>";
    }
