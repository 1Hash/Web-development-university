...
<html lang="pt-br">
  <head>
    ...
    <title>Meu Perfil - ELentes</title>
      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3 m-b-3">
          ...
          <ul class="nav nav-pills nav-stacked">
            <li role="presentation" class="active"><a href="perfil-usuario.php">Perfil</a></li>
            <li role="presentation"><a href="historico-compras.php">Histórico de Compras</a></li>
            <li role="presentation"><a href="alterar-senha-usuario.php">Alterar Senha</a></li>
          </ul>
        </div>
        <!-- End Account Sidebar -->
        ...
        <div class="col-sm-8 col-md-9">
          <div class="title m-b-2"><span>Perfil</span></div>
          <div class="row">
            <div class="col-xs-12">
                  ...
                  <?php
                    foreach($usuario->getUsuario($_SESSION['usuario']) as $var) {
                        ...
                        <li class="list-group-item">
                          <strong>Nome</strong>
                          <p><?php echo $var['nome'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>Sobrenome</strong>
                          <p><?php echo $var['sobrenome'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>E-mail</strong>
                          <p><?php echo $var['e-mail'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>Telefone</strong>
                          <p><?php echo $var['telefone'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>Endereço</strong>
                          <p><?php echo $var['endereço'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>Número</strong>
                          <p><?php echo $var['numero'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>Complemento</strong>
                          <p><?php echo $var['complemento'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>Bairro</strong>
                          <p><?php echo $var['bairro'] ?></p>
                        </li>
                        <li class="list-group-item">
                          <strong>CEP</strong>
                          <p><?php echo $var['cep'] ?></p>
                        </li>
                        <li class="list-group-item">
                          ...
                          foreach($ec->ConsultarNomeEstado($var['idEstado']) as $varEC) {
                          ?>
                          <p><?php echo $varEC['estNome'] ?></p>
                          <?php
                          }
                          ?>
                        ...
                        <li class="list-group-item">
                          ...
                          foreach($ec->ConsultarNomeCidade($var['idCidade']) as $varEC) {
                          ?>
                          <p><?php echo $varEC['cidNome'] ?></p>
                          <?php
                          }
                          ?>
              ...
              <a href="alterar-usuario.php" class="btn btn-theme pull-right"><i class="fa fa-pencil"></i> Alterar Meu Perfil</a>
            </div>
          </div>
        </div>
