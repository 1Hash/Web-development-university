  ...
  <body class="fade-down">
      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="dicas">Dicas</a></li>
    ...
    <div class="container m-t-3">
      <div class="row">
        ...
        <!-- Content -->
        <div class="col-sm-12">
          <div class="title m-b-2"><span>Dicas</span></div>
          ...
          <?php
            ...
            $totalProdutosPorPagina = 4;
            $totalProdutosPorLinha = 2;
            $totalLinhasPorPagina = 2;
            ...
            $sqlProdutos = "SELECT * FROM dicas LIMIT $numeroSelecao,$totalProdutosPorPagina";
          ...
          <div class="row">
              ...
              <?php foreach ($consulta as $var) {  $cont++;?>
              
              <?php                      
                    $url = $var['titulo']."-".$var['idDicas'];
                    $url = strtolower($url);
                    $url = retirarAcentos($url);
                    $url = str_replace(' ', '-', $url);

                    $descricao = explode(".", $var['descricao']);
              ?>
              
                <div class="col-md-6">
                  <div class="thumbnail blog-list">
                    <a href="<?php echo "$urlSite/dica-detalhe/$url"; ?>">
                        <img src="./controls/controlUsuario.php?getImagemD=<?php echo $var['idDicas']; ?>" alt="">                      
                    </a>
                    <div class="caption">
                      <h4><?php echo $var['titulo']; ?></h4>
                      <small>
                        <span><i class="fa fa-clock-o"></i> <?php echo date("d/m/Y", strtotime($var['data'])); ?></span>
                        <span><i class="fa fa-user"></i> Admin</span>
                      </small>
                      <p><?php echo $descricao[0]."."; ?></p>
                      <div class="text-right"><a href="<?php echo "$urlSite/dica-detalhe/$url"; ?>" class="btn btn-theme btn-sm"><i class="fa fa-long-arrow-right"></i> Saiba Mais</a></div>
                    </div>
                  </div>
                </div>
...
function paginacao($totalProdutos, $totalProdutosPorPagina, $offset) {
    ...
    if ($paginaAtual == 1) {
        ...
        $p = $paginaAtual - 1;
        $paginas .= "<li><a href='$urlSite/dica/1'><span>&laquo;</span></a></li>";
        $paginas .= "<li><a href='$urlSite/dica/$p'><span>&lsaquo;</span></a></li>";
    }
    ...
    for ($i = $var; $i < ($paginaAtual - 1) + $offset; $i++ ) {
      ...
      if ($i <= $numeroPaginas && $i >= 1) {
            ...
            if ($i == $var2) {
                $paginas .= " <li class='active'><a href='$urlSite/dica/$página'>$página</a></li> ";
            }
            else {
                $paginas .= " <li><a href='$urlSite/dica/$página'>$página</a></li> ";
            }
        }
    }
    ...
    if ($paginaAtual == $numeroPaginas) {
        ...
        $p2 = $paginaAtual + 1;
        $paginas .= "<li><a href='$urlSite/dica/$p2'><span>&rsaquo;</span></a></li>";
        $paginas .= "<li><a href='$urlSite/dica/$numeroPaginas'><span>&raquo;</span></a></li>";
    }
